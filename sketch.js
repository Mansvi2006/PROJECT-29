...
function setup() {
  ...
  box17= new Box(680,140);
  box18= new Box(700,140);
  box19= new Box(720,140);
  box20= new Box(740,140);
  box21= new Box(760,140);


  box8 = new Box(310,300);
  box9 = new Box(330,300);
  box10 = new Box(350,300);
  box11 = new Box(370,300);
  box12 = new Box(390,300);
  box22 = new Box(390,300);
  box23 = new Box(390,300);
  box24 = new Box(390,300);


  box13 = new Box(330,260);
  box14 = new Box(350,260);
  box15 = new Box(370,260);
  box16 = new Box(350,220);
